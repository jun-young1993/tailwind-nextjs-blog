...
export async function getTagsWithPostCount(): Promise<
  TagsWithPostCountOperation['data']['getTagsWithPostCount']
> {
...
export async function createPost(
  variables: BasePostOperation['variables']
): Promise<BasePostOperation['data']['createPost']> {
...
): Promise<LoginOperation['data']['login']> {
